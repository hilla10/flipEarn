  ...
  if (!orders.length) {
    return (
      <div className='px-4 md:px-6 lg:px-24 xl:px-32'>
        <div className='maw-w-2xl mx-auto mt-14 bg-white rounded-xl border border-gray-200 p-8 text-center'>
                  ...
                  <div className='flex items-start justify-between gap-4'>
                    <div>
                      ...
                      <div className='flex  gap-2 mt-2'>
                        {listing.verified && (
                          <span className='flex items-center text-xl bg-indigo-50 text-indigo-600 px-2 py-1 rounded-md'>
