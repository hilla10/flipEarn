      ...
      <div className='py-10'>
        ...
        <div className='relative max-w-xl mb-8'>
          ...
          <input
            ...
            class='w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-indigo-500'
            type='text'
            value={searchQuery}
        ...
        {loading ? (
          ...
          <div className='bg-white rounded-lg shadow-xs border border-gray-200 p-16 text-center'>
            ...
            <h3 className='text-xl font-medium text-gray-800 mb-2'>
              {searchQuery ? 'No Chats Found' : 'No messages yes.'}
            </h3>
            <p className='text-gray-600'>
              {searchQuery
                ? 'Try a different search term'
                : 'State a conversation by viewing a listing and clicking "Chat with Seller"'}
            </p>
          </div>
        ) : (
