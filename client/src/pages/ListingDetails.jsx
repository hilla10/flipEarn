    ...
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32 '>
        ...
        <div className='flex-1 max-md:w-full'>
          ...
          <div className='bg-white rounded-xl border border-gray-200 mb-5'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4 p-4 text-center'>
              <div>
                <Users className='mx-auto text-gray-400 size-5 mb-1' />
              ...
              <div>
                <LineChart className='mx-auto text-gray-400 size-5 mb-1' />
                <p className='font-semibold text-gray-800'>
              ...
              <div>
                <Eye className='mx-auto text-gray-400 size-5 mb-1' />
                <p className='font-semibold text-gray-800'>
              ...
              <div>
                <Calendar className='mx-auto text-gray-400 size-5 mb-1' />
                <p className='font-semibold text-gray-800'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 p-4 text-sm'>
              ...
              <div>
                ...
                <p className='flex items-center font-medium'>
                  <MapPin className='size-r mr-1 text-gray-400' />
                  {listing.country}
                </p>
              </div>
              ...
              <div>
                ...
                <p className='font-medium'>
                  {listing.platformVerified ? 'Yes' : 'No'}
                </p>
              </div>
              <div>
      ...
      <div className='bg-white border-t border-gray-200 p-4 text-center mt-28'>
        <p className='text-sm text-gray-500'>
          ...
          <span className='text-indigo-600'> Profile Marketplace</span> All
          rights reserved.
        </p>
      </div>
    </div>
